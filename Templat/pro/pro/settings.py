...
58cd5e02ff9ed78361f0ca23fe105de3463aa134
...
SECRET_KEY = 'django-insecure-jdgh(8y%zf25vk_33azp-(_djjdo6($c!w@ay7-2dwngm$_2$y'
...
MIDDLEWARE = [
    'pro.middleware.BlockIPMiddleware',
    'pro.middleware.LogRequestMiddleware',
    'pro.middleware.TimerMiddleware',
